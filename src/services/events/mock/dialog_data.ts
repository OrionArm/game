...
export const dialogData: Record<string, DialogNode> = {
  CH01_S1: {
    id: 'CH01_S1',
    speaker: 'Система',
    text: 'Вы входите в ТЦ. Вокруг витрины, баннеры и бесплатный Wi‑Fi. Главное — не терять бдительность.',
    options: [
      {
        id: 'a',
  ...
  CH01_S3: {
    id: 'CH01_S3',
    speaker: 'Система',
    text: 'Вам предлагают оплатить покупки переводом денег по номеру телефона',
    options: [
      {
        id: 'a',

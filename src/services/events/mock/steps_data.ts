    ...
    dialog: [
      {
        id: 'E005-dialog',
        speaker: 'Система',
        text: 'В кошельке пустовато, но в магазине акция. Решаете, что важнее — план или скидка.',
        options: [
          {
            id: 'E005-option-a',
    ...
    dialog: [
      {
        id: 'E011-dialog',
        speaker: 'Система',
        text: 'Стиральная машина требует ремонта. Нужно решить, как это оплатить, не руша планы.',
        options: [
          {
            id: 'E011-option-a',
    ...
    dialog: [
      {
        id: 'E015-dialog',
        speaker: 'Система',
        text: 'Смартфон треснул и просит внимания. Решаете, что выгоднее: ремонт, замена или пауза.',
        options: [
          {
            id: 'E015-option-a',
    ...
    dialog: [
      {
        id: 'E008-dialog',
        speaker: 'Система',
        text: 'Новый месяц — повод выбрать одну простую привычку и удержать её. Варианты разные, смысл один — стать чуть лучше.',
        options: [
          {
            id: 'E008-option-a',
    ...
    dialog: [
      {
        id: 'E010-dialog',
        speaker: 'Система',
        text: 'Приложение напоминает про лимиты и уведомления по карте. Пара минут — меньше рисков.',
        options: [
          {
            id: 'E010-option-a',
    ...
    dialog: [
      {
        id: 'E006-dialog',
        speaker: 'Система',
        text: 'Перед вами три банки: «подушка», «мечта», «сюрпризы». Куда отправить сегодняшние монеты?',
        options: [
          {
            id: 'E006-option-a',
